...
const output_0 = new FileOutput("outputs/select_fields.csv");
fields_0.registerConsumer(output_0);
const output_1 = new FileOutput("outputs/select_input_copy.csv");
input_0.registerConsumer(output_1);
const output_2 = new FileOutput("outputs/select_filtered.csv");
